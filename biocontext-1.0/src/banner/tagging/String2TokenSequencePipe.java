...
public class String2TokenSequencePipe extends Pipe
{
    ...
    public Instance pipe(Instance carrier)
    {
        ...
        for (int i = 0; i < tokens.length; i++)
        {
            ...
            String text = split[0];
            String tag = split.length > 1 ? split[1] : null; //TODO: changed
            ...
            if (tag != null) //TODO: changed
            	target.add(tag);
            else{
            	target.add("O");
            	System.out.println("null-target for token: " + tokens[i]);
            }
    ...
    private int[] getPOS(String[] tokens)
    {
        ...
        for (int i = 0; i < tokens.length; i++)
        {
            ...
            if (rawTokens[i].length() > 0) //TODO: changed
