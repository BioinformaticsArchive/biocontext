...
public class Directory implements DocumentIterator {
	...
	public Directory(File dir, InputFactory factory, String acceptedSuffix, boolean recursive){
		this(new File[]{dir},factory,acceptedSuffix,recursive);
	}

		public Directory(File[] dirs, InputFactory factory, String acceptedSuffix, boolean recursive){
		this.acceptedSuffix = acceptedSuffix;
		this.recursive = recursive;
		this.factory = factory;

		if (dirs == null || dirs.length == 0 || !dirs[0].isDirectory()){
		...
		this.contents = contents.toArray(new File[0]);
